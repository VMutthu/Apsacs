...
public class SessionManager {
    ...
    public static final String PREF_NAME = "com.entrolabs.mosquitolarvaldensity.SessionFile";
    ...
    public void createLoginSession(JSONObject res) {
        try {
            ...
            storeVal(Helper.Apsacs_Role,res.getString("role"));
            storeVal(Helper.Apsacs_Username, res.getString("name"));
            storeVal(Helper.Apsacs_Name,res.getString("name"));
            storeVal(Helper.Apsacs_Mobile, res.getString("mobile"));
            storeVal(Helper.Apsacs_Rolename,res.getString("rolename"));
    ...
    public void logoutUser() {
        ...
        editor.clear();
        editor.commit();
        SharedPreferences ratePrefs = _context.getSharedPreferences("com.entrolabs.mosquitolarvaldensity.routines", 0);
